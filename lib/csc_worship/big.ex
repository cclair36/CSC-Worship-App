defmodule CscWorship.Big do
  ...
  def list_services do
    p = Repo.all(Service)
    Repo.preload(p, [:drums, :piano, :acoustic_guitar, :electric_guitar, :sounds, :sound_board, :projection, :singer, :singer2, :singer3, :singer4, :speaker, :bass])
  end
 ...
 @doc """
  ...
  def create_service(attrs \\ %{}) do
    ...
    |> Repo.insert()
    |> case do
      {:ok, post} -> {:ok, Repo.preload(post,  [:drums, :piano, :acoustic_guitar, :electric_guitar, :sounds, :sound_board, :projection, :singer, :singer2, :singer3, :singer4, :speaker, :bass])}
      error -> error
    end
  end
