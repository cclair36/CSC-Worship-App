defmodule CscWorship.Email do
  ...
  def volunteer_notification_email(user) do
    ...
    } at CSC. If you will be unable to fill this role, please let Cody or Elyse know ASAP and update your availability in the office. </p>
    ...
    String.slice(p, 5..7) <> String.slice(p, 8..9) <> "-" <> String.slice(p, 0..3)} at CSC. If you will be unable to fill this role, please let Cody or Elyse know ASAP and update your availability in the office. \n
  ...
  def rehearsal_update_email(user) do
    ...
    def no_longer_serving(user) do
      ...
      String.slice(p, 5..7) <> String.slice(p, 8..9) <> "-" <> String.slice(p, 0..3)} at CSC. </p> <h3> If there is anything else we can do, please let us know! God bless. </h3> <p> In Christ, the CSC Worship Leadership Team (Cody and Elyse) </p>")
