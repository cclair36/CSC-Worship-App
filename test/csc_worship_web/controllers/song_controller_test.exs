defmodule CscWorshipWeb.SongControllerTest do
  use CscWorshipWeb.ConnCase

  import CscWorship.BigFixtures

  @create_attrs %{name: "some name", type: "some type", artist: "some artist", songselect: "some songselect", youtube: "some youtube"}
